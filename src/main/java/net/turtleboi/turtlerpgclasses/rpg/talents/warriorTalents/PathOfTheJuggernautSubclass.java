...
public class PathOfTheJuggernautSubclass extends Talent {
    public static final String Name = Component.translatable("subclass.juggernaut.talent").getString();

    public static String getSubclassName(){
        return Component.translatable("subclass.juggernaut.name").getString();
    }
