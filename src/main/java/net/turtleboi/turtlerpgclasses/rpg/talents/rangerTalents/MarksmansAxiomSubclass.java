...
public class MarksmansAxiomSubclass extends Talent {
    private static final String Name = Component.translatable("subclass.marksman.talent").getString();
...
//
    ...
    public static String getSubclassName(){return Component.translatable("subclass.marksman.name").getString();}
}