...
public class BeastmastersAxiomSubclass extends Talent {
    private static final String Name = Component.translatable("subclass.beastmaster.talent").getString();
...
//
    ...
    public static String getSubclassName(){return Component.translatable("subclass.beastmaster.name").getString();}
}