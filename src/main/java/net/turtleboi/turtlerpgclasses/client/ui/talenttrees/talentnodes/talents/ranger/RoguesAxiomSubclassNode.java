...
public class RoguesAxiomSubclassNode extends ActiveTalentButton {
    public RoguesAxiomSubclassNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
