...
public class BrawlersTenacityTalentNode extends PassiveTalentButton {
    public BrawlersTenacityTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
