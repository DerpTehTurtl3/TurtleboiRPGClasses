...
public class MarathonerTalentNode extends StatTalentButton {
    public MarathonerTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
