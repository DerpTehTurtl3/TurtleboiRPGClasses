...
public class BattleHardenedTalentNode extends StatTalentButton {
    ...
    public List<Component> generateDynamicTooltip() {
        ...
        double statMultiplier = 1;//Change this value for each talent
        double currentRankValue = (currentPoints * statMultiplier);
        double nextRankValue = (currentRankValue + statMultiplier);
        boolean isShiftPressed = Screen.hasShiftDown();

        tooltip.add(Component.translatable("talents.battle_hardened")//Change this value for each talent
        ...
        if (currentPoints == 0) {
            tooltip.add(Component.translatable("talents.player_gains")
                    .append(Component.literal(" +1.0/2.0/3.0 ")
                            .withStyle(Style.EMPTY.withColor(TextColor.parseColor("#00FF00"))))
                    .append(Component.translatable("talents.armor_points")));//Change this value for each talent
