...
public class EtherealArrowTalentNode extends ActiveTalentButton {
    public EtherealArrowTalentNode(TalentTree talentTree, Talent talent, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
