...
public class GuerrillaWarfareTalentNode extends ActiveTalentButton {
    public GuerrillaWarfareTalentNode(TalentTree talentTree, Talent talent, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
    ...
    public List<Component> generateDynamicTooltip() {
        ...
        tooltip.add(Component.literal("Placeholder")//Change this value for each talent
