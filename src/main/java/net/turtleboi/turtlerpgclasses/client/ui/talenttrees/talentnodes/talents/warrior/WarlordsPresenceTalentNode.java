...
public class WarlordsPresenceTalentNode extends CapstoneTalentButton {
    public WarlordsPresenceTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
