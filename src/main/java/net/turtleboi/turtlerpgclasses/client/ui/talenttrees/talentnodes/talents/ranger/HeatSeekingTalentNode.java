...
public class HeatSeekingTalentNode extends PassiveTalentButton {
    public HeatSeekingTalentNode(TalentTree talentTree, Talent talent, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
