...
public class EvasiveManeuversTalentNode extends PassiveTalentButton {
    public EvasiveManeuversTalentNode(TalentTree talentTree, Talent talent, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
