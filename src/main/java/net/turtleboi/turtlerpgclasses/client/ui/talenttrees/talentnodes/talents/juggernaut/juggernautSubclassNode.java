package net.turtleboi.turtlerpgclasses.client.ui.talenttrees.talentnodes.talents.juggernaut;
...
public class juggernautSubclassNode extends CapstoneTalentButton {
    public juggernautSubclassNode(TalentTree talentTree, Talent talent, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress) {
    ...
    public List<Component> generateDynamicTooltip() {
        ...
        tooltip.add(Component.translatable("talents.subclass.juggernaut"));
