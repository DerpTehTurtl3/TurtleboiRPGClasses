...
public class ExecutionersAxeItem extends SwordItem {
    ...
    public ExecutionersAxeItem(Tier tier, int attackDamage, float attackSpeed, Properties properties) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.turtlerpgclasses.executioners_axe.desc")
...
//
    ...
    //        if (entity instanceof LivingEntity && entity != player && !isAlly(player, entity)) {
    ...
    //    // Implement your logic to determine if the entity is an ally of the player
    //    // This could be based on team, faction, or any other criteria you define
